...
public class CodeGeneratorService {
    ...
    public static void generateServiceModule() {
        // 逻辑删除
        ...
        focList.add(new FileOutConfig("/templates/convertMapper.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/src/main/java/com/example/service/entity/" + entityName.toLowerCase() + "/" + tableInfo.getEntityName() + "ConvertMapper" + StringPool.DOT_JAVA;
            }
        });
        /*EntityVO*/
        focList.add(new FileOutConfig("/templates/entityVO.java.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/src/main/java/com/example/service/entity/" + entityName.toLowerCase() + "/" + tableInfo.getEntityName() + "VO" + StringPool.DOT_JAVA;
            }
...
//            public String outputFile(TableInfo tableInfo) {
//                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
//                return projectPath + "/src/main/java/com/example/service/entity/" + entityName.toLowerCase() + "/index.vue";
//            }
//
//        });
        cfg.setFileCreate(new IFileCreate() {
            ...
            public boolean isCreate(ConfigBuilder configBuilder, FileType fileType, String filePath) {
                // 判断自定义文件夹是否需要创建
                checkDir("/src/main/java/com/example/service/entity/" + entityName.toLowerCase());
